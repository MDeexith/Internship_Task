...
function App () {
  ...
  return (
    <div className="w-full h-screen overflow-auto pb-20 relative scroll-smooth">
      ...
      <div className="flex p-5 bg-blue-100">
        <p className="text-xl font-semibold underline">Deexith Madas</p>
      </div>
      ...
      <div className="w-full">
        ...
        <div id="teams-created" className="mt-5 mb-5">
        ...
        {
          curTeam.length > 0 && 
        <Card className="w-full my-10 px:5 sm:px-10">
            <div className="flex justify-center items-center bg-yellow-100 p-5">
                <div className="w-full max-w-3xl flex flex-col sm:flex-row justify-center sm:justify-between items-center gap-3">
                    ...
                    <div className="flex justify-center items-center gap-4">
                        <button 
                            className="px-4 py-2 bg-blue-300 rounded-lg hover:bg-blue-400 active:bg-blue-400 transition-all"
        ...
        <div className="mb-5 flex justify-center items-center gap-5">
          ...
          <button 
            ...
            className="px-4 py-2 bg-blue-200 rounded-lg hover:bg-blue-300 active:bg-blue-300 transition-all"
          >
            Add User
          </button>
        </div>
        ...
        <div className="mt-10 w-full flex justify-center items-center flex-wrap gap-5">
          <button 
            ...
            className="px-4 py-2 bg-gray-400 rounded-lg hover:bg-slate-300 active:bg-slate-300 transition-all disabled:cursor-not-allowed"
